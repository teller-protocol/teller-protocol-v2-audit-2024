    ...
    PausableUpgradeable
{
    ...
    uint16 public collateralRatio; //the overcollateralization ratio, typically over 100% pct
    ...
    */
    function initialize(
        ...
        require(interestRateUpperBound <= 50000, "invalid _interestRateUpperBound");
